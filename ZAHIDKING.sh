...
${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Customized by ZAHID KING 👑${WHITE}
EOF
}
...
banner_small() {
	cat <<- EOF
${BLUE}╔════════════════════════════════════════════╗
${BLUE}║            Z A H I D   K I N G 👑             ║
${BLUE}║          S Y S T E M   O N L I N E           ║
${BLUE}║          A C C E S S   G R A N T E D        ║
...
main_menu() {
	...
	cat <<- EOF
		...
		${WHITE}[${GREEN}::${WHITE}]${RED} ZAHID KING 👑: ${WHITE}[${GREEN}::${WHITE}]${RED}
